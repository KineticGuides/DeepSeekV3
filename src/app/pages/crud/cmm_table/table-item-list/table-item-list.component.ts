...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, NgxPaginationModule, SearchFilterPipe, FormsModule, TableItemFormComponent],
  templateUrl: './table-item-list.component.html',
  styleUrl: './table-item-list.component.css'
})
export class TableItemListComponent   implements OnInit {
