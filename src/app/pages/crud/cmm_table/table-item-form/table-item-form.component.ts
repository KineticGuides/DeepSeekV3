...
@Component({
  selector: 'app-table-item-form',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './table-item-form.component.html',
  styleUrl: './table-item-form.component.css'
})
export class TableItemFormComponent  implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'table-column-form';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
