...
import { UserActivityFormComponent } from '../user-activity-form/user-activity-form.component';
@Component({
  selector: 'app-user-activity-list',
  standalone: true,
  imports: [CommonModule, RouterLink, NgxPaginationModule, SearchFilterPipe, FormsModule, UserActivityFormComponent],
