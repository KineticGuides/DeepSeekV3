...
@Component({
  selector: 'app-user-activity-form',
  standalone: true,
   imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './user-activity-form.component.html',
  styleUrl: './user-activity-form.component.css'
})
 export class UserActivityFormComponent implements OnInit, AfterViewInit { 
  data: any;
  ...
  @Input() path: any = 'get-user-activity-form';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
