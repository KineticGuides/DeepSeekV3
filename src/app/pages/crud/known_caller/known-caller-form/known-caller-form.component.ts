...
@Component({
  selector: 'app-known-caller-form',
  standalone: true,
   imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './known-caller-form.component.html',
  styleUrl: './known-caller-form.component.css'
})
 export class KnownCallerFormComponent implements OnInit, AfterViewInit { 
  data: any;
  ...
  @Input() path: any = 'get-known-caller-form';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
