...
export class AddMarkerComponent  implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'add-marker-form';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
  ...
  deleteForm() {
    if (confirm('Are you sure you want to Delete this record?')) {
      this._dataService.postData("post-marker-delete", this.formData).subscribe((data: any)=> { 
        //this.data=data;
        //this.formData=data['formData'];
        this.closeIt();
  ...
  postForm(): void {
    this._dataService.postData("post-add-marker", this.formData).subscribe((data: any)=> { 
      //this.data=data;
      //this.formData=data['formData'];
      this.closeIt();
      console.log(this.data)
