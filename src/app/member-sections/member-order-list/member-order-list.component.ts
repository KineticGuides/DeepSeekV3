...
@Component({
  selector: 'app-member-order-list',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule,SearchFilterPipe, NgxPaginationModule],
  templateUrl: './member-order-list.component.html',
  styleUrl: './member-order-list.component.css'
})
export class MemberOrderListComponent   implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'member-orders-list';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
