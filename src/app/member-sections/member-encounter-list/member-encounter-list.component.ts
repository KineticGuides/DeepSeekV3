...
@Component({
  selector: 'app-member-encounter-list',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './member-encounter-list.component.html',
  styleUrl: './member-encounter-list.component.css'
})
export class MemberEncounterListComponent   implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'member-encounter-list';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
