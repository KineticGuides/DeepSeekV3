...
@Component({
  selector: 'app-member-note-list',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule,SearchFilterPipe, NgxPaginationModule],
  templateUrl: './member-note-list.component.html',
  styleUrl: './member-note-list.component.css'
})
export class MemberNoteListComponent   implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'member-notes-list';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
