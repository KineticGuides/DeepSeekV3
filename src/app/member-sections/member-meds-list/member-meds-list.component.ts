...
@Component({
  selector: 'app-member-meds-list',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './member-meds-list.component.html',
  styleUrl: './member-meds-list.component.css'
})
export class MemberMedsListComponent   implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'member-meds-list';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
