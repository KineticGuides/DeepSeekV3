...
@Component({
  selector: 'app-member-programs-list',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, SearchFilterPipe, NgxPaginationModule],
  templateUrl: './member-programs-list.component.html',
  styleUrl: './member-programs-list.component.css'
})
export class MemberProgramsListComponent   implements OnInit, AfterViewInit {
  ...
  @Input() path: any = 'member-programs-list';
  @Input() id: any = '';
  @Input() id2: any = '';
  @Input() id3: any = '';
