...
@Component({
  selector: 'app-dietexercise-chatbot',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './dietexercise-chatbot.component.html',
  styleUrl: './dietexercise-chatbot.component.css'
})
export class DietexerciseChatbotComponent  implements OnInit, AfterViewInit, AfterViewChecked {
