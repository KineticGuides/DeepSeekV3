...
@Component({
  selector: 'app-general-medical-chatbot',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './general-medical-chatbot.component.html',
  styleUrl: './general-medical-chatbot.component.css'
})
export class GeneralMedicalChatbotComponent  implements OnInit, AfterViewInit, AfterViewChecked {
