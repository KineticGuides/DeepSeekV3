...
@Component({
  selector: 'app-longevity-chatbot',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './longevity-chatbot.component.html',
  styleUrl: './longevity-chatbot.component.css'
})
export class LongevityChatbotComponent  implements OnInit, AfterViewInit, AfterViewChecked {
