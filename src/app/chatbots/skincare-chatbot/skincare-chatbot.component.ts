...
@Component({
  selector: 'app-skincare-chatbot',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule],
  templateUrl: './skincare-chatbot.component.html',
  styleUrl: './skincare-chatbot.component.css'
})
export class SkincareChatbotComponent  implements OnInit, AfterViewInit, AfterViewChecked {
