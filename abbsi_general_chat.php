...
$bearer="";
$sql="select open_webui from abbsi_system";
$rs=$X->sql($sql);
foreach($rs as $r) {
    $b=$r['open_webui'];
}

//$bearer = "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImZmNTA2MDI4LWQ2M2QtNGJhMS1iODc0LTI0NDhkNDUxNGEzNSJ9.1V3BpWmP0vfsh6-5vykLjT34IAya0-YycFZOQymS_Mk";
$bearer = "Authorization: " . $b;
